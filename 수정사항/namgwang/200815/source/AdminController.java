...
public class AdminController {
	...
	public String updateMtDate(			
		...
		String path = "C:/Users/pieis/eclipse-workspace/realMulti/src/main/webapp/resources/images/";
		String path2= "C:/Users/pieis/eclipse-workspace/realMulti/src/main/webapp/";

		//이미지를 올렸다면
		if(file.getOriginalFilename()!= null && file.getOriginalFilename()!="")
		{
			System.out.println("이전 이미지:" + pastimg);
			
			//200808
			//기본 이미지는 지우지 않는다.
			if(!pastimg.equals("resources/images/default.png")) {
				System.out.println("코끼리 아니면 지운다.");
				
				new File(path2 + pastimg).delete();	
			}
			else {
				System.out.println("디폴트 코끼리입니다.");
			}
	...
	public String uploadMTimg(@RequestParam("file") MultipartFile file, 
		...
		if(file.getOriginalFilename()!= null && file.getOriginalFilename()!="")
		{
			...
			//200808
			//기본 이미지는 지우지 않는다.
			if(pastimg!="resources/images/default.png") {				
				new File(path2 + pastimg).delete();	
			}
			else {
				System.out.println("디폴트 코끼리입니다!!");
